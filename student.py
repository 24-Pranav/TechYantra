...
class Student:
    ...
    # This part is image labels setting start
        # first header image
        img = Image.open(
            r"Resources/collegestudents.jpg")
        img = img.resize((775, 150), Image.LANCZOS)
        self.photoimg = ImageTk.PhotoImage(img)

        # set image as lable
        f_lb1 = Label(self.root, image=self.photoimg)
        f_lb1.place(x=0, y=0, width=775, height=150)

        # second header image
        img2 = Image.open(
            r"Resources\buddies.jpg")
        img2 = img2.resize((775, 150), Image.LANCZOS)
        self.photoimg2 = ImageTk.PhotoImage(img2)

        # set image as lable
        f_lb2 = Label(self.root, image=self.photoimg2)
        f_lb2.place(x=775, y=0, width=775, height=150)

        # backgorund image
        bg1 = Image.open(
            r"Resources\colorful.png")
        bg1 = bg1.resize((1800, 1000), Image.LANCZOS)
        self.photobg1 = ImageTk.PhotoImage(bg1)

        # set image as lable
        bg_img = Label(self.root, image=self.photobg1)
        bg_img.place(x=0, y=130, width=1800, height=1000)

        # title section
        title_lb1 = Label(bg_img, text="Welcome to Student Panel", font=(
            "verdana", 30, "bold"), bg="white", fg="navyblue")
        title_lb1.place(x=0, y=0, width=1550, height=45)

        # Creating Frame
        main_frame = Frame(bg_img, bd=2, bg="white")  # bd mean border
        main_frame.place(x=5, y=70, width=1520, height=580)

        # Left Label Frame
        left_frame = LabelFrame(main_frame, bd=2, bg="grey", relief=RIDGE,
                                text="Student Details", font=("verdana", 12, "bold"), fg="navyblue")
        left_frame.place(x=10, y=10, width=745, height=560)

        # Current Course
        current_course_frame = LabelFrame(left_frame, bd=2, bg="lightgreen", relief=RIDGE, text="Current Course", font=(
            "verdana", 12, "bold"), fg="magenta")
        current_course_frame.place(x=10, y=5, width=715, height=150)

        # label Department
        dep_label = Label(current_course_frame, text="Department", font=(
            "verdana", 12, "bold"), bg="lightgreen", fg="navyblue")
        ...
        cou_label = Label(current_course_frame, text="Course", font=(
            "verdana", 12, "bold"), bg="lightgreen", fg="navyblue")
        cou_label.grid(row=0, column=2, padx=40, pady=15,sticky=W)
        ...
        year_label = Label(current_course_frame, text="Semester", font=(
            "verdana", 12, "bold"), bg="lightgreen", fg="navyblue")
        year_label.grid(row=1, column=2, padx=40, sticky=W)
        ...
        class_Student_frame = LabelFrame(left_frame, bd=2, bg="white", relief=RIDGE,
                                         text="Class Student Information", font=("verdana", 12, "bold"), fg="salmon")
        class_Student_frame.place(x=10, y=160, width=715, height=360)
        ...
        studentId_entry.grid(row=0, column=1, padx=5, pady=15, sticky=W)

        # Student name
        student_name_label = Label(class_Student_frame, text="Std-Name:",
                                   font=("verdana", 12, "bold"), fg="navyblue", bg="white")
        student_name_label.grid(row=0, column=2, padx=40, pady=15, sticky=W)

        student_name_entry = ttk.Entry(
            class_Student_frame, textvariable=self.var_std_name, width=15, font=("verdana", 12, "bold"))
        student_name_entry.grid(row=0, column=3, padx=5, pady=15, sticky=W)
        ...
        student_roll_label = Label(class_Student_frame, text="Roll-No:",
                                   font=("verdana", 12, "bold"), fg="navyblue", bg="white")
        student_roll_label.grid(row=1, column=2, padx=40, pady=5, sticky=W)
        ...
        student_gender_label = Label(class_Student_frame, text="Gender:", font=(
            "verdana", 12, "bold"), fg="navyblue", bg="white")
        student_gender_label.grid(row=2, column=0, padx=5, pady=15, sticky=W)
        ...
        student_dob_label = Label(class_Student_frame, text="DOB:", font=(
            "verdana", 12, "bold"), fg="navyblue", bg="white")
        student_dob_label.grid(row=2, column=2, padx=40, pady=15, sticky=W)

        student_dob_entry = ttk.Entry(
            class_Student_frame, textvariable=self.var_dob, width=15, font=("verdana", 12, "bold"))
        student_dob_entry.grid(row=2, column=3, padx=5, pady=15, sticky=W)
        ...
        student_mob_label = Label(class_Student_frame, text="Mob-No:",
                                  font=("verdana", 12, "bold"), fg="navyblue", bg="white")
        student_mob_label.grid(row=3, column=2, padx=40, pady=5, sticky=W)
        ...
        btn_frame.place(x=10, y=460, width=715, height=60)

        # save button
        save_btn = Button(btn_frame, command=self.add_data, text="Save", width=8, font=(
            "verdana", 12, "bold"), fg="white", bg="green")
        save_btn.grid(row=0, column=0, padx=5, pady=10, sticky=W)

        # update button
        update_btn = Button(btn_frame, command=self.update_data, text="Update", width=8, font=(
            "verdana", 12, "bold"), fg="white", bg="orange")
        update_btn.grid(row=0, column=1, padx=5, pady=8, sticky=W)

        # delete button
        del_btn = Button(btn_frame, command=self.delete_data, text="Delete", width=8, font=(
            "verdana", 12, "bold"), fg="white", bg="red")
        del_btn.grid(row=0, column=2, padx=5, pady=10, sticky=W)

        # reset button
        reset_btn = Button(btn_frame, command=self.reset_data, text="Reset", width=8, font=(
            "verdana", 12, "bold"), fg="white", bg="blue")
        reset_btn.grid(row=0, column=3, padx=5, pady=10, sticky=W)

        # take photo button
        take_photo_btn = Button(btn_frame, command=self.generate_dataset, text="Take Pic", width=10, font=(
            "verdana", 12, "bold"), fg="black", bg="magenta")
        take_photo_btn.grid(row=0, column=4, padx=5, pady=10, sticky=W)

        # update photo button
        update_photo_btn = Button(btn_frame, text="Update Pic", width=11, font=(
            "verdana", 12, "bold"), fg="black", bg="slateblue")
        update_photo_btn.grid(row=0, column=5, padx=5, pady=10, sticky=W)

        # ----------------------------------------------------------------------
        # Right Label Frame
        right_frame = LabelFrame(main_frame, bd=2, bg="grey", relief=RIDGE,
                                 text="Student Details", font=("verdana", 12, "bold"), fg="navyblue")
        right_frame.place(x=755, y=10, width=750, height=560)

        # Searching System in Right Label Frame
        search_frame = LabelFrame(right_frame, bd=2, bg="lightgreen", relief=RIDGE,
                                  text="Search System", font=("verdana", 12, "bold"), fg="salmon")
        search_frame.place(x=10, y=5, width=715, height=80)

        # Phone Number
        search_label = Label(search_frame, text="Search:", font=(
            "verdana", 12, "bold"), fg="navyblue", bg="lightgreen")
        ...
        search_btn = Button(search_frame, command=self.search_data, text="Search", width=9, font=(
            "verdana", 12, "bold"), fg="white", bg="magenta")
        ...
        table_frame.place(x=10, y=90, width=715, height=430)
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_course.get == "Select Course" or self.var_year.get() == "Select Year" or self.var_semester.get() == "Select Semester" or self.var_std_id.get() == "" or self.var_std_name.get() == "" or self.var_div.get() == "" or self.var_roll.get() == "" or self.var_gender.get() == "" or self.var_dob.get() == "" or self.var_email.get() == "" or self.var_mob.get() == "" or self.var_address.get() == "" or self.var_teacher.get() == "":
            ...
            try:
                ...
                mycursor.execute("insert into student values('"+self.var_std_id.get()+"','"+self.var_std_name.get()+"','"+self.var_dep.get()
                                 +"','"+self.var_course.get()+"','"+self.var_year.get()+"','"+self.var_semester.get()+"','"+self.var_div.get()
                                 +"','"+self.var_gender.get()+"','"+self.var_dob.get()+"','"+self.var_mob.get()+"','"+self.var_address.get()+"','"+
                                 self.var_roll.get()+"','"+self.var_email.get()+"','"+self.var_teacher.get()+"','"+self.var_radio1.get()+"')")
                conn.commit()
                self.fetch_data()
                conn.close()
                messagebox.showinfo(
        ...
        if self.var_dep.get() == "Select Department" or self.var_course.get == "Select Course" or self.var_year.get() == "Select Year" or self.var_semester.get() == "Select Semester" or self.var_std_id.get() == "" or self.var_std_name.get() == "" or self.var_div.get() == "" or self.var_roll.get() == "" or self.var_gender.get() == "" or self.var_dob.get() == "" or self.var_email.get() == "" or self.var_mob.get() == "" or self.var_address.get() == "" or self.var_teacher.get() == "":
            ...
            try:
                ...
                if Update > 0:
                    conn = sqlite3.connect(r"database.db")
                    mycursor = conn.cursor()
                    mycursor.execute("update student set Name='"+self.var_std_name.get()+"',Department='"+self.var_dep.get()+
                                     "',Course='"+self.var_course.get()+"',Year='"+self.var_year.get()+"',Semester='"+self.var_semester.get()
                                     +"',Division='"+self.var_div.get()+"',Gender='"+self.var_gender.get()+"',DOB='"+self.var_dob.get()+
                                     "',Mobile_No='"+self.var_mob.get()+"',Address='"+self.var_address.get()+"',Roll_No='"+self.var_roll.get()
                                     +"',Email='"+self.var_email.get()+"',Teacher_Name='"+self.var_teacher.get()+"',PhotoSample='"+self.var_radio1.get()
                                     +"' where Student_ID='"+self.var_std_id.get()+"'")
                else:
                    if not Update:
                        return
                messagebox.showinfo(
    ...
    def delete_data(self):
        if self.var_std_id.get() == "":
            ...
            try:
                ...
                if delete > 0:
                    sql = "delete from student where Student_ID='"+self.var_std_id.get()+"'"
    ...
    def generate_dataset(self):
        if self.var_dep.get() == "Select Department" or self.var_course.get == "Select Course" or self.var_year.get() == "Select Year" or self.var_semester.get() == "Select Semester" or self.var_std_id.get() == "" or self.var_std_name.get() == "" or self.var_div.get() == "" or self.var_roll.get() == "" or self.var_gender.get() == "" or self.var_dob.get() == "" or self.var_email.get() == "" or self.var_mob.get() == "" or self.var_address.get() == "" or self.var_teacher.get() == "":
            ...
            try:
                ...
                mycursor.execute("update student set Name='"+self.var_std_name.get()+"',Department='"+self.var_dep.get()+"',Course='"+self.var_course.get()
                                 +"',Year='"+self.var_year.get()+"',Semester='"+self.var_semester.get()+"',Division='"+self.var_div.get()+"',Gender='"+ self.var_gender.get()
                                 +"',DOB='"+self.var_dob.get()+"',Mobile_No='"+self.var_mob.get()+"',Address='"+self.var_address.get()+"',Roll_No='"+self.var_roll.get()
                                 +"',Email='"+self.var_email.get()+"',Teacher_Name='"+self.var_teacher.get()+"',PhotoSample='"+self.var_radio1.get()+"' where Student_ID='"+id+"'")
                conn.commit()
                self.fetch_data()
                self.reset_data()
                conn.close()
                ...
                while True:
                    ...
                    if cv2.waitKey(1) == 15 or int(img_id) == 50:
                        break
                cap.release()
